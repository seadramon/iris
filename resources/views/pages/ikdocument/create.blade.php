			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-header">
						<!--begin::Card title-->
						<div class="card-title fs-3 fw-bolder">Create Data</div>
						<!--end::Card title-->
					</div>
					<!--end::Card header-->
					<!--begin::Form-->
					@if (isset($data))
	                    {!! Form::model($data, ['route' => ['ikdocument.store'], 'class' => 'form', 'id' => 'kt_project_settings_form', 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
	                @else
	                ...
	                @endif
						...
						<div class="card-body p-9">
							...
							<div class="form-group">
								...
								{!! Form::select('kd_alat', $code, null, ['class'=>'form-select', 'id'=>'kd_alat', 'data-control' => 'select2']) !!}
							</div>
