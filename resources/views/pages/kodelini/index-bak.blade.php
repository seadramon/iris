				...
				<div class="card mb-5 mb-xl-8">
					...
					<div class="card-header border-0 pt-5">
						<h3 class="card-title align-items-start flex-column">
							<span class="card-label fw-bolder fs-3 mb-1">List Kode Lini</span>
...
@section('extra-js')
    ...
    $(document).ready(function () {
        ...
        $('#kt_datatable_example_5').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('kodelini.data') }}",
            "columns": [          
                {data: 'kd_lini', name: 'kd_lini', defaultContent: '-'},
