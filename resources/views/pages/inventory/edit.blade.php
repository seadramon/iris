		...
		<div class="post d-flex flex-column-fluid" id="kt_post">
			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<!--begin::Form-->
					@if (isset($data))
	                    {!! Form::model($data, ['url' => route('inventory.update', ['inventory' => $data->no_inventaris]), 'class' => 'form', 'id' => 'kt_project_settings_form', 'method' => 'PUT']) !!}
	                @else
	                    {!! Form::open(['url' => route('inventory.update'), 'class' => 'form', 'id' => 'kt_project_settings_form']) !!}
	                @endif
						<!--begin::Card body-->
							...
							<div class="row mb-8">
								<div class="col-xl-8">
									...
									<div class="form-group">
										...
										{!! Form::text('kd_merk', null, ['class'=>'form-control', 'id'=>'kd_merk', $disabled]) !!}
									</div>
									...
									<div class="form-group">
										...
										{!! Form::number('persen_kondisi', null, ['class'=>'form-control', 'id'=>'persen_kondisi', $disabled]) !!}
									</div>
									...
									<div class="form-group">
										...
										{!! Form::select('last_update_by', $pic, null, ['class'=>'form-select', 'id'=>'last_update_by', 'data-control' => 'select2']) !!}
									</div>
